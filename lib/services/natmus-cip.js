...
var CLIENT_CACHE_TIME = 1000 * 60 * 10;
...
exports.initSession = function(forceInit) {
  ...
  if (nm && !forceInit) {
    ...
    if (process.env.CIP_USERNAME === undefined ||
        process.env.CIP_PASSWORD === undefined) {
    ...
    .then(function() {
      ...
      cache.put('nm', nm, CLIENT_CACHE_TIME);
      return nm;
    }, function() {
...
exports.getAsset = function(nm, catalog, id) {
  var cacheKey = 'asset_' + catalog + '_' + id;
  var asset = cache.get(cacheKey);
  ...
  if (asset) {
    ...
    return nm.getAsset(catalog, id, true)
...
exports.binaryToObject = function(binaryBase64Encoded) {
...
exports.parseBinaryRelations = function(binaryBase64Encoded) {
  var result = [];
  var relatedAssets = exports.binaryToObject(binaryBase64Encoded);
  if (relatedAssets) {
