...
exports.index = function(req, res, next) {
  ...
  .then(function(metadata) {
    ...
    if (config.enableGeotagging) {
      ...
      var outdoors = metadata.tags_vision;
      console.log(metadata.tags_vision);
      var fhmOrOut = rightCatalog || outdoors;
      showGeotagging = fhmOrOut && !metadata.google_maps_coordinates;
