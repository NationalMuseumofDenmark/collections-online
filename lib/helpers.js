...
helpers.getDate = function(metadata, path) {
  ...
  if(typeof(property) == 'string') {
    ...
    if (isNaN(date)) throw SyntaxError("Could not parse date " + property);
