...
var typesInConfiguration = _.flatten(sections.map((section) => {
...
var assetSectionsTemplatePath = jade.resolvePath('/includes/asset-sections');
var assetSectionsTemplate = jade.compileFile(assetSectionsTemplatePath);
